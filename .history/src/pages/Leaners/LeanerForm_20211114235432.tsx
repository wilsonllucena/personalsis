...
const LeanerForm: React.FC = () => {
	...
	return (
		<>
			...
			<form onSubmit={handleSubmit(onSubmitForm)} className="px-4 py-3 mb-8 w-full bg-white rounded-lg shadow-md dark:bg-gray-800">
				...
				<Label className="mt-4">
					<span>Semana</span>
					<Select css="" { ...register("week_id")} className="mt-1">
                        <option></option>
                        { weeks.map(week => (
                ...
                <Label className="mt-4">
					...
					<Select css="" { ...register("frequency_id")}  className="mt-1">
                    <option></option>
                ...
                <Label className="mt-4">
					...
					<Select css="" { ...register("location_id")} className="mt-1">
                        <option></option>
                ...
                <Button type="submit" className="bg-blue-600 mt-4">Salvar</Button>
			</form>
		</>
	);
};
